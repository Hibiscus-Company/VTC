...
def main():
    ...
    raise SystemExit(
        "--mode validate was removed in the original/ port: it depended on fieldlib + cached\n"
        "harness artifacts that lived on the 2026 competition machine's job scratch.\n"
        "The as-run validation code is preserved in archive/jobs/. Use --mode apply.")
