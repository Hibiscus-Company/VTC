...
def main():
    ...
    variants = [
        ...
        ("q100 ss2 prog", dict(quality=100, subsampling=2, optimize=True, progressive=True)),
        ("q99  ss2 prog", dict(quality=99, subsampling=2, optimize=True, progressive=True)),
        ("q98  ss2 prog", dict(quality=98, subsampling=2, optimize=True, progressive=True)),
        ("q97  ss2 prog", dict(quality=97, subsampling=2, optimize=True, progressive=True)),
        ("q96  ss2 prog", dict(quality=96, subsampling=2, optimize=True, progressive=True)),
        ("q95  ss2 prog", dict(quality=95, subsampling=2, optimize=True, progressive=True)),
        ("q93  ss2 prog", dict(quality=93, subsampling=2, optimize=True, progressive=True)),
    ]
