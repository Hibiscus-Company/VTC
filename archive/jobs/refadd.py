...
BASE = ["gsplatB9ut", "gsplatB10ut8M", "m31b_nolpips", "m31b_taillpips",
        "e15ceil95", "e17visnorm"]
ADD = {
    "add_same_UT": ["gsplatB11ut60k", "gsplatB12ut8Ms7"],
    "add_new_wp":  ["gsplatB4warm", "gsplatB8pure"],
    "add_new_B12": ["gsplatB1", "gsplatB2"],
    "add_new_B35": ["gsplatB3", "gsplatB5affine"],
}
...
def main():
    ...
    ap.add_argument("--out", default=f"{HERE}/refadd.json")
